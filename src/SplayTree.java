...
//    Node newNode = null;
    ...
    public void insertSplay(boolean file1, boolean file2, boolean file3, boolean file4, String value){
        insertSplay(new Node(file1, file2, file3, file4, value));
    }
...
//            temp.setRight(temp.getRight());
    ...
    //    todo here just to make a node
    public void delete(String toDelete){
        delete(new Node(false, false, false, false, toDelete));
    }
    ...
    // todo check to see if this is correct later
